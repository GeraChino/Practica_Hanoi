...
Hanoi:
	...
	add $a1, $a2, $zero		#x2
	add $a2, $t7, $zero		#x3
	addi $sp, $sp, -8		#-8 sp to store $ra and number of discs
	
#-----------------------stores recursion variables in the stack --------------------------	
...
# Number of discs and return address ($ra) won't load as variables just yet, to correctly execute step-2 
#-----------------------------------------Step 2-------------------------------------------
	add $t7, $a1, $zero		#se voltean las torres del paso 2 para siguiente movimiento de paso 2
	add $a1, $a2, $zero		#x2
	add $a2, $t7, $zero		#x3
	jal CasoBase
#-----------------------------------------Step 3-------------------------------------------
	...
	addi $s1, $s1, -1		
	addi $sp, $sp, 8		#1 iteration out of the recursion
